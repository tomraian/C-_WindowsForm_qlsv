...
namespace qlsv_hoangduy {
    ...
    public partial class qlsvDataSet1 : global::System.Data.DataSet {
        ...
        public partial class lopDataTable : global::System.Data.TypedTableBase<lopRow> {
            ...
            [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
            [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "16.0.0.0")]
            public lopRow AddlopRow(int id, string malop, string tenlop) {
...
namespace qlsv_hoangduy.qlsvDataSet1TableAdapters {
    ...
    public partial class lopTableAdapter : global::System.ComponentModel.Component {
        ...
        private void InitAdapter() {
            ...
            this._adapter.DeleteCommand.CommandText = "DELETE FROM [dbo].[lop] WHERE (([id] = @Original_id) AND ((@IsNull_malop = 1 AND " +
                "[malop] IS NULL) OR ([malop] = @Original_malop)) AND ((@IsNull_tenlop = 1 AND [t" +
                "enlop] IS NULL) OR ([tenlop] = @Original_tenlop)))";
            ...
            this._adapter.InsertCommand.CommandText = "INSERT INTO [dbo].[lop] ([id], [malop], [tenlop]) VALUES (@id, @malop, @tenlop);\r" +
                "\nSELECT id, malop, tenlop FROM lop WHERE (id = @id)";
            ...
            this._adapter.UpdateCommand.CommandText = @"UPDATE [dbo].[lop] SET [id] = @id, [malop] = @malop, [tenlop] = @tenlop WHERE (([id] = @Original_id) AND ((@IsNull_malop = 1 AND [malop] IS NULL) OR ([malop] = @Original_malop)) AND ((@IsNull_tenlop = 1 AND [tenlop] IS NULL) OR ([tenlop] = @Original_tenlop)));
SELECT id, malop, tenlop FROM lop WHERE (id = @id)";
        ...
        private void InitConnection() {
            ...
            this._connection.ConnectionString = global::qlsv_hoangduy.Properties.Settings.Default.qlsvConnectionString;
        }
        ...
        private void InitCommandCollection() {
            ...
            this._commandCollection[0].CommandText = "SELECT id, malop, tenlop FROM dbo.lop";
        ...
        public virtual int Delete(int Original_id, string Original_malop, string Original_tenlop) {
        ...
        public virtual int Insert(int id, string malop, string tenlop) {
        ...
        public virtual int Update(int id, string malop, string tenlop, int Original_id, string Original_malop, string Original_tenlop) {
        ...
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        [global::System.ComponentModel.DataObjectMethodAttribute(global::System.ComponentModel.DataObjectMethodType.Update, true)]
        public virtual int Update(string malop, string tenlop, int Original_id, string Original_malop, string Original_tenlop) {
            return this.Update(Original_id, malop, tenlop, Original_id, Original_malop, Original_tenlop);
        }
    }
